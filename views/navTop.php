...
<div class="row">
	<div class="col-md-12">
		<div class="btn-group" role="group">
			...
			<button id="btn-sync" type="button" class="btn-sm btn-success d-none d-md-inline" data-toggle="tooltip" data-placement="top" title="Verificación de Guías Liberadas">
